        ...
        <div className="drawer-side ">
            ...
            <XMarkIcon className="h-5 inline-block w-5"/>
                ...
                <li className="mb-2 font-semibold text-xl" onMouseOver={handleMouseOver} onMouseOut ={handleMouseOut}>
                    <Link to={'/app/welcome'}><img className={active ? "background-color-custom-pink" : "background-color-custom-blue" } src="/logo-cobalt.original.svg" alt="Official Charts Logo"/></Link> </li>
                {
                    routes.map((route, k) => {
                        return(
                            <li className="" key={k}>
